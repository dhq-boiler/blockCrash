...
int  __stdcall dx_FileRead_size( const char *  FilePath)
{
...
int  __stdcall dx_FileRead_tell( int  FileHandle)
{
	return FileRead_tell( FileHandle);
}
int  __stdcall dx_FileRead_seek( int  FileHandle, int  Offset, int  Origin)
{
...
int  __stdcall dx_SetUseGraphZBuffer( int  GrHandle, int  UseFlag)
{
	return SetUseGraphZBuffer( GrHandle, UseFlag);
}
...
int  __stdcall dx_DrawCircleGauge( int  CenterX, int  CenterY, double  Percent, int  GrHandle)
{
	return DrawCircleGauge( CenterX, CenterY, Percent, GrHandle);
}
...
int  __stdcall dx_SetRenderTargetToShader( int  TargetIndex, int  DrawScreen)
{
	return SetRenderTargetToShader( TargetIndex, DrawScreen);
}
...
BASEIMAGE * __stdcall dx_GetMovieBaseImageToGraph( int GraphHandle ) 
{
	return GetMovieBaseImageToGraph( GraphHandle  ) ;
}
...
int  __stdcall dx_MV1SetupReferenceMesh( int  MHandle, int  FrameIndex, int  IsTransform)
{
	return MV1SetupReferenceMesh( MHandle, FrameIndex, IsTransform);
}
int  __stdcall dx_MV1TerminateReferenceMesh( int  MHandle, int  FrameIndex, int  IsTransform)
{
	return MV1TerminateReferenceMesh( MHandle, FrameIndex, IsTransform);
}
int  __stdcall dx_MV1RefreshReferenceMesh( int  MHandle, int  FrameIndex, int  IsTransform)
{
	return MV1RefreshReferenceMesh( MHandle, FrameIndex, IsTransform);
}
MV1_REF_POLYGONLIST __stdcall dx_MV1GetReferenceMesh( int MHandle , int FrameIndex , int IsTransform ) 
{
	return MV1GetReferenceMesh( MHandle , FrameIndex , IsTransform  ) ;
}
